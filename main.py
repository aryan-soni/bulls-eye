...
class Stock:
	...
	def get_month_return(self, end_index=1):
	    """ Determines a stock's total return (%) for the previous month
		...
		adjusted_end_price = float(self.stock_data[end_key]["5. adjusted close"])
		start_price = float(self.stock_data[start_key]["4. close"])

		total_returns = ((adjusted_end_price - start_price) / start_price) * 100
...
#print(data)
#print(test_stock.get_month_return())
